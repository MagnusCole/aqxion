...
import { TrackRecordCard, TrackRecordCardProps } from './TrackRecordCard'

export interface TrackRecordCarouselProps {
  items: TrackRecordCardProps[];
  cardSize?: 'sm' | 'md' | 'lg';
...
/**
 * Componente TrackRecordCarousel - Carrusel para mostrar tarjetas de trayectoria y resultados
 */
export const TrackRecordCarousel: React.FC<TrackRecordCarouselProps> = ({
  items,
  cardSize = 'md',
  showIndicators = true,
  showArrows = true,
