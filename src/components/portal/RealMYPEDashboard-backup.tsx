...
/**
 * Dashboard Nativo iOS - AQXION
 * 
 * Siguiendo Human Interface Guidelines de Apple:
 * - Tipografía limpia y clara
 * - Espaciado consistente (8pt grid)
 * - Sombras sutiles
 * - Patrones de interacción familiares
 * - Colores sólidos (no gradientes exagerados)
 */
