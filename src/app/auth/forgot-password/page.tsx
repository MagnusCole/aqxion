  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        setMessage('✅ Email de reset enviado. Revisa tu bandeja de entrada.')
      }
    } catch (error) {
      console.error('❌ Error inesperado:', error)
      setError('Error inesperado durante el reset')
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Te enviaremos un email para resetear tu contraseña</p>
          </div>
